programa
{
	...
	funcao inicio()
	{
		inteiro cont=0,soma_num_dig=0, som_num_dig=0, quant_num_dig = 1, med_num_dig=0, maior_num_dig=1, menor_num_dig=1, med_par_dig=0, soma_im_dig=1, soma_par_dig=1, numero=1, porcentagem=1, por_impar_dig=1 
